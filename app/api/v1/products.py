...
# ---- admin routes
@router.post('/', response_model=ProductFromDB, response_model_by_alias=False, status_code=status.HTTP_200_OK, dependencies=[Depends(RoleChecker(['admin']))])
...
@router.patch('/{product_id}', response_model=ProductFromDB, response_model_by_alias=False, status_code=status.HTTP_200_OK, dependencies=[Depends(RoleChecker(['admin']))])
...
@router.delete('/{product_id}', status_code=status.HTTP_200_OK, dependencies=[Depends(RoleChecker(['admin']))])
